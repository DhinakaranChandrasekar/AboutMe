...
export const projects: Project[] = [
  {
    title: "Rate Parity Insights Dashboard",
    description:
      "Developed a global Rate Parity Insights Dashboard that visualizes hotel competitiveness across regions. The app aggregates and displays data for parity, undercut, and competitive rates using an interactive world map. Implemented geo-based filtering by chain, brand, region, and country with dynamic tooltips and color-coded markers for visual clarity. Achieved seamless performance through optimized rendering and responsive design for desktop and tablet users.",
    image: Project7,
    category: "web",
  },
  {
    title: "Chain Performance Pulse Dashboard",
    description:
      "Built an advanced Chain Performance Pulse Dashboard to monitor KPIs such as rooms revenue, ADR, room nights, and guest arrivals. Designed and implemented interactive charts for pickup and pace trends with real-time data updates and period comparison modes. Focused on data accuracy, accessibility, and responsiveness, ensuring smooth cross-browser performance and scalability. The dashboard enables hospitality stakeholders to analyze performance trends efficiently and make data-driven decisions.",
    image: Project8,
    category: "web",
  },
  {
  ...
  },
  {
    ...
    category: "data",
    github:
      "https://github.com/DhinakaranChandrasekar/Music-Genre-Classification",
  },

  {
    ...
    category: "data",
    github:
      "https://github.com/DhinakaranChandrasekar/Facial-Edge-detection-and-segmentation",
  },
  {
